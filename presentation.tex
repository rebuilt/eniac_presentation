...
Example Artillary
\begin{figure}[h]
  \begin{flushleft}Howitzer \end{flushleft} \includegraphics[width=0.25\linewidth]{howitzer_105-mm-1200_480.jpg}  \\
  \begin{flushleft}Tank \end{flushleft} \includegraphics[width=0.2\linewidth]{m4-sherman.jpg} \\
  \begin{flushleft}Anti-Aircraft \end{flushleft} \includegraphics[width=0.2\linewidth]{Anti-Aircraft_Artillery_37mm_Halftrack_and_Thompson.jpg} \\
\end{figure}
}
\end{frame}
...
\fbckg{ibm_card_punch.jpg} % Slide background image
\begin{frame}
\framedsl{IBM Card Punch} % Text in this environment will be made large, uppercase and will wrap multiple lines
\end{frame}
...
\framedsl{
  ...
  \pitem{No separation between starage and computation} 
  \fitem{Parallel}} 
\end{frame}
...
\includegraphics[scale=0.048]{2.jpg} \ flickr/lovelornpoets\\
\includegraphics[scale=0.12]{2.jpg} \ flickr/apsmuseum
}
\end{frame}
