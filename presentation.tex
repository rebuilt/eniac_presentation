...
\begin{frame}
  \framedsl{
    \pitem{Compressible laminar boundary layer flow}
    \pitem{Zero-pressure properties of diatomic gases}
    \fitem{Reflection and refraction of plane shock waves}
  }
\end{frame}
%------------------------------------------------
